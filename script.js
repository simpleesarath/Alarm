const setHours = document.querySelector("#hours"); /*here is some constants*/
...
function dropDownMenu(start, end, element) {               /*here r some sort of functions to perform diff tasks*/
